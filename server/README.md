...
5 Configured the Uncomplicated Firewall (UFW) to only allow incoming connections
...
6 Configured the local timezone to UTC. This was done via the command below and following the visual instructions of the
utility.  
```bash
...
service apache2 restart
```  
9 Installed git, cloned and setup my Catalog App project (from your GitHub repository from earlier in the Nanodegree program) 
